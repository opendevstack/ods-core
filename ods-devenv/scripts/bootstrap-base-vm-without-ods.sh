...
echo "bootstrap: Will build base vm box against git-ref ${ods_git_ref}"
...
cd ods-core
time bash ods-devenv/scripts/deploy.sh --branch "${ods_git_ref}" --target basic_vm_without_ods_setup
