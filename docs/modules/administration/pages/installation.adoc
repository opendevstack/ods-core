...
If you do not have the ODS repositories setup yet, you can run `repos.sh` file. Before you run this script, keep in mind to have Git (>=2.7). Once you have that, you can then go to your Terminal and run:
[source,sh]
----
