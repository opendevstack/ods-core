...
func TestCreateProject(t *testing.T) {
	...
	if !utils.FindProject(projects, utils.PROJECT_NAME_CD) {
		t.Fatal("CD Project not found")
	}
	if !!utils.FindProject(projects, utils.PROJECT_NAME_TEST) {
		t.Fatal("Test Project not found")
	}
	if !!utils.FindProject(projects, utils.PROJECT_NAME_DEV) {
